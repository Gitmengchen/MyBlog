<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"F:\phpstudy\WWW\thinkphp5\public/../application/admin\view\login\login.html";i:1502698221;}*/ ?>
<!DOCTYPE html>
        ...
        <section class="panel panel-default bg-white m-t-lg">
            ...
            <form method="post" action="" class="panel-body wrapper-lg">
                ...
                <div class="form-group">
                    ...
                    <img img src="<?php echo captcha_src(); ?>" alt="captcha" onclick="this.src=this.src+'?'+Math.random()">
                </div>
