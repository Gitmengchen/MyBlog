<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"F:\phpstudy\WWW\thinkphp5\public/../application/admin\view\category\edit.html";i:1502800048;s:68:"F:\phpstudy\WWW\thinkphp5\public/../application/admin\view\base.html";i:1502779236;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="js-example-basic-single form-control" name="cate_pid">
                                    ...
                                    <option <?php if($oldData['cate_pid']==$vo['cate_id']): ?>selected<?php endif; ?> value="<?php echo $vo['cate_id']; ?>"><?php echo $vo['cate_id']; ?></option>
